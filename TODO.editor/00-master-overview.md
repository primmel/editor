...
| 36 | the audit close-out (AGENTS.md + AUDIT.md) | P1 | audit | ✅ de4e2b7 |
| 37 | the mirror converter pipeline (Metanorma → JSON) | P0 | oiml-cs | ✅ 4d01394 |
| 38 | the mirror document-model | P0 | oiml-cs | ✅ e4f0287 + d279842 |
| 39 | the OIML-CS corpus + the certification-workflow model | P0 | oiml-cs | ✅ 4606a65 |
| 40 | the OIML-CS authoring audit (the plugin gaps) | P1 | oiml-cs | ✅ dd13908 |
